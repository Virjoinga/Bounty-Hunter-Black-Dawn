...
public class ItemRec110 : ISubRecordset
{
	private ItemInfo m_ItemInfo;

	public ItemRec110(ItemInfo itemInfo)
	{
		m_ItemInfo = itemInfo;
	}
	...
	public void SaveData(BinaryWriter bw)
	{
		...
		bw.Write(m_ItemInfo.Bag_Extend_Time);
	}
	...
	public void LoadData(BinaryReader br)
	{
		...
		m_ItemInfo.Bag_Extend_Time = br.ReadInt32();
	}
	...
	protected void SaveItem(NGUIBaseItem baseItem, BinaryWriter bw)
	{
		...
		bw.Write(baseItem.UpgradeTimes);
	}
	...
	protected void LoadItem(ref NGUIBaseItem baseItem, BinaryReader br)
	{
		...
		byte upgradeTimes = br.ReadByte();
		baseItem.UpgradeTimes = upgradeTimes;
	}
}
