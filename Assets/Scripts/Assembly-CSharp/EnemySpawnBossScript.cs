...
public class EnemySpawnBossScript : MonoBehaviour, EffectsCameraListener, UIArenaResultListener
{
	protected static EnemySpawnBossScript instance;
	...
	public static EnemySpawnBossScript GetInstance()
	{
		return instance;
	}
	...
	private IEnumerator Start()
	{
		...
		spIndex = 0;
		skySpIndex = 0;
		instance = GameObject.Find("TraditionalSpawns").GetComponent<EnemySpawnBossScript>();
		...
		UnitDataTable dataTable = Res2DManager.GetInstance().vDataTable[75 + stableID];
		int waveNum = 1;
	...
	public void InitEnemy(byte enemyID)
	{
		...
		if (enemy != null)
		{
			...
			enemy.SpawnType = ESpawnType.BOSS_RUSH;
			enemy.Activate();
