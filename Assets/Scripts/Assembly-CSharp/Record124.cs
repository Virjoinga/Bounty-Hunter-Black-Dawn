...
public class Record124 : IRecordset
{
	...
	public void SaveGlobalData(BinaryWriter bw)
	{
		...
		bw.Write(globalState.GetDoubleExp());
		bw.Write(globalState.GetInfiniteRPGBullet());
		bw.Write(globalState.GetInfiniteSMGBullet());
		bw.Write(globalState.GetNewbieGift1());
		bw.Write(globalState.GetNewbieGift2());
	...
	public void LoadGlobalData(BinaryReader br)
	{
		...
		bool doubleExp = br.ReadBoolean();
		bool infiniteRPGBullet = br.ReadBoolean();
		bool infiniteSMGBullet = br.ReadBoolean();
		bool newbieGift = br.ReadBoolean();
		bool newbieGift2 = br.ReadBoolean();
		...
		globalState.SetDoubleExp(doubleExp);
		globalState.SetInfiniteRPGBullet(infiniteRPGBullet);
		globalState.SetInfiniteSMGBullet(infiniteSMGBullet);
		globalState.SetNewbieGift1(newbieGift);
		globalState.SetNewbieGift2(newbieGift2);
