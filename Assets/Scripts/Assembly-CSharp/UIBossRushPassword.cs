...
public class UIBossRushPassword : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		{
			Room curRoom = UIBossRushTeam.m_instance.m_roomList.GetCurRoom();
			if (curRoom == null)
			{
				OnClickCancel(null);
			}
	...
	{
		UIBossRushTeam.m_instance.m_roomList.SetRefreshFlag(true);
