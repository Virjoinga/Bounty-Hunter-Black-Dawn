...
public class LaserShotScript : MonoBehaviour
{
	...
	private void OnTriggerStay(Collider other)
	{
		...
		else if (other.gameObject.layer == PhysicsLayer.REMOTE_PLAYER && isLocal && GameApp.GetInstance().GetGameMode().IsMultiPlayer() && GameApp.GetInstance().GetGameMode().IsVSMode() && GameApp.GetInstance().GetGameMode().IsTeamMode())
		{
