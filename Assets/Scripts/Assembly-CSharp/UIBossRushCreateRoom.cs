...
public class UIBossRushCreateRoom : MonoBehaviour, UIMsgListener
{
	...
	{
		UIBossRushTeam.m_instance.m_createRoom.SetActive(false);
		UIBossRushTeam.m_instance.m_roomList.gameObject.SetActive(true);
	}
