...
public class MachineGun : Weapon
{
	...
	public override void StopFire()
	{
		...
		if (AudioManager.GetInstance().IsPlayingSound(base.Name + "_FiringSound_02") && !stopped)
		{
		...
		{
			entityObject.GetComponent<Animation>().Stop();
		}
	}
	...
	public override void CreateTrajectory()
	{
		...
		entityObject.GetComponent<Animation>()["Take 001"].wrapMode = WrapMode.Loop;
		entityObject.GetComponent<Animation>().Play("Take 001");
